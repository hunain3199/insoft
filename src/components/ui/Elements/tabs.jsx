...
before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-full before:bg-gray-400 before:scale-x-0 before:transition-transform before:origin-left hover:before:scale-x-100 lg:hover:before:bg-blue-500
`,
      className
    )}
    {...props}
