const InfoSection = () => {
  return (
    <section class=" bg-[#C4C4C426] py-4 lg:py-8 ">
      <div class="container flex sm:flex-row flex-col items-center justify-center gap-y-3 sm:gap-[20px]  relative lineCustom ">
        <div class="sm:w-[40%] w-full">
          <h4 class="text-center sm:text-start text-[14px] sm:text-[18px] font-semibold md:text-[30px] lg:text-[38px] md:leading-[35px] lg:leading-[44px]">
            Cubicus is a lean creative agency that uses design &amp; code to
            solve problems
          </h4>
        </div>
        <div class="sm:w-[60%] w-full d-flex justify-end items-end">
          <p class="max-w-[250px] mx-auto sm:max-w-[800px] text-center sm:text-start sm:pl-[20px] text-[12px] md:text-[14px] lg:text-[18px] font-medium leading-[160%] tracking-[0.36px] text-black/50 ">
