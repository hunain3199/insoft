    ...
    <main className="bg-[#f9f9fb]">
      <section className="pb-5 lg:pb-28 pt-[30px]">
        <div className="container ">
          ...
          <div className="mx-auto max-w-[920px] text-black/50 font-medium text-[14px] tracking-[2%] text-center lg:leading-[28.8px] md:text-[14px] lg:text-[18px] ">
          ...
          <div className="container flex sm:flex-row flex-col items-center justify-between gap-1 md:gap-4 ">
            <div className="sm:w-[40%] w-full">
              <h2 className="text-[14px] sm:text-[24px] md:leading-7 md:text-left lg:leading-[52px] font-[600] lg:pl-5 md:text-[28px] text-center lg:text-[40px]">
                <span className="text-[#2555bb]">Cubicus</span> is more than
                just a name!
              </h2>
            </div>
            <div className="sm:w-[60%] sm:pl-10 sm:border-l-4">
              <p className="text-[10px] tracking-[2%] font-medium lg:leading-[28.8px] text-black/50 md:text-[14px] text-center lg:text-left lg:text-[18px]">
        ...
        <div className="bg-white w-full mx-auto md:py-5 py-2">
          <div className="max-w-[939px] mx-auto flex flex-col justify-center items-center my-2 sm:my-5">
            <h3 className="font-[600] text-[18px] text-[#2555bb] sm:text-[24px] md:text-[28px] lg:text-[40px] lg:leading-[56px] text-center text-[#00000] max-w-[290px] mb-1 sm:mb-2">
              Our Vision
            </h3>
            <p className="font-[500] px-3 lg:leading-[28px] tracking-[2%] max-w-[910px] text-[12px] md:text-[14px] lg:text-[18px] text-center text-black/50">
          ...
          <div className="max-w-[929px] mx-auto flex flex-col justify-center items-center my-2 sm:my-5">
            <h3 className="font-[600] text-[18px text-[#2555bb] sm:text-[24px] md:text-[28px] lg:text-[40px] lg:leading-[56px] text-center max-w-[290px] mb-1 sm:mb-2">
              Our Objective
            </h3>
            <p className="font-[500] px-3 lg:leading-[28px] tracking-[2%] max-w-[910px] text-[12px] md:text-[14px] lg:text-[18px] text-center text-black/50">
        ...
        <div className="bg-[#C4C4C426] w-full mx-auto sm:py-5 py-2">
          <div className="container flex items-center justify-between sm:gap-5 sm:flex-row flex-col-reverse">
            <div className="w-full sm:w-[50%] sm:pr-14 sm:border-r-4">
              <p className="max-w-[638px] text-[10px] sm:py-3 font-[500] tracking-[2%] text-center md:text-left lg:leading-[28.8px] text-black/50 md:text-[14px] lg:text-[18px]">
        ...
        <div className="bg-white w-full mx-auto py-5 sm:py-5">
          <div className="container mx-auto flex flex-col justify-center items-center sm:my-5">
            <p className="font-[500] text-[12px] lg:leading-[28px] text-center md:text-left tracking-[2%] md:text-[14px] lg:text-[18px] text-black/50 mb-3">
        ...
        <div className="max-w-[1400px] mx-auto w-full flex flex-col items-center justify-center gap-5 bg-[#C4C4C426] sm:flex-col md:flex-row  sm:rounded-r-3xl sm:rounded-l-[5px]">
          <div className="sm:pl-[3rem] w-full sm:px-0 px-3">
            ...
            <p className="lg:mt-5 my-2 text-[10px] text-center md:text-left sm:text-[14px] font-medium lg:leading-[27px] text-black/50 lg:text-[18px] max-w-[490px]">
